...
def _clean(starting_kit_dir):
    ...
    temp_dir = os.path.join(starting_kit_dir, 'temp_output')
...
def _parse_args():
    ...
    default_dataset_dir = join(default_starting_kit_dir, 'data', 'a')
    default_code_dir = join(default_starting_kit_dir, 'code_submission', '0_baseline')
