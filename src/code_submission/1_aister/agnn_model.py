...
class AGNN(torch.nn.Module):
    ...
    def __init__(self,categories_nums, features_num=16, num_class=2, sparse=False):
        ...
        self.lin1 = torch.nn.Linear(embed_size*len(categories_nums)+features_num, hidden)
...
class AGNNModel:
    ...
    def init_model(self,model_data,table):
        ...
        data = model_data.agnn_data
        sparse = table.sparse
        categories_nums = data.categories_nums
        
        model = AGNN(categories_nums,features_num=data.x.size()[1], num_class=table.n_class,sparse=sparse)
    ...
    def get_train_and_valid(self,table,train_valid_idx,valid_idx,seed=None):
        ...
        valid_model_data.agnn_data = data
